...
## catalog/21-search-and-reporting.md
...
This document details the `catalog` capability specs for the `21 Search And Reporting` contract.

### REQ-CATALOG-21SEARCHANDREPORTING-001
