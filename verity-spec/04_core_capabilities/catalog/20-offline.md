...
This document maps all write actions and entity fields within the `catalog` capability to their designated Conflict Policy class.
...
### REQ-CATALOG-OFFLINE-001
*   **Requirement**: Every mutating transaction in `catalog` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
