...
## asset/25-failure-and-exceptions.md
...
This document details the `asset` capability specs for the `25 Failure And Exceptions` contract.

### REQ-ASSET-25FAILUREANDEXCEPTIONS-001
