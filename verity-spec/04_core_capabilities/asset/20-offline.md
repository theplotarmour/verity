...
This document maps all write actions and entity fields within the `asset` capability to their designated Conflict Policy class.
...
### REQ-ASSET-OFFLINE-001
*   **Requirement**: Every mutating transaction in `asset` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
