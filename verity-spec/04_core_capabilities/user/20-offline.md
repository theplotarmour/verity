...
This document maps all write actions and entity fields within the `user` capability to their designated Conflict Policy class.
...
### REQ-USER-OFFLINE-001
*   **Requirement**: Every mutating transaction in `user` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
