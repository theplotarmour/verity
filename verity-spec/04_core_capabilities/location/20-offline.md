...
This document maps all write actions and entity fields within the `location` capability to their designated Conflict Policy class.
...
### REQ-LOCATION-OFFLINE-001
*   **Requirement**: Every mutating transaction in `location` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
