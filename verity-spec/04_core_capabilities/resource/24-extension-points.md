...
## resource/24-extension-points.md
...
This document details the `resource` capability specs for the `24 Extension Points` contract.

### REQ-RESOURCE-24EXTENSIONPOINTS-001
