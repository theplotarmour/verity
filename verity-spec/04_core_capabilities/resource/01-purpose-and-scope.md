...
## resource/01-purpose-and-scope.md
...
This document details the `resource` capability specs for the `01 Purpose And Scope` contract.

### REQ-RESOURCE-01PURPOSEANDSCOPE-001
