...
This document maps all write actions and entity fields within the `resource` capability to their designated Conflict Policy class.
...
### REQ-RESOURCE-OFFLINE-001
*   **Requirement**: Every mutating transaction in `resource` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
