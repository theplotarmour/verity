...
## resource/28-acceptance-criteria.md
...
This document details the `resource` capability specs for the `28 Acceptance Criteria` contract.

### REQ-RESOURCE-28ACCEPTANCECRITERIA-001
