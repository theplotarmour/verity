...
## resource/25-failure-and-exceptions.md
...
This document details the `resource` capability specs for the `25 Failure And Exceptions` contract.

### REQ-RESOURCE-25FAILUREANDEXCEPTIONS-001
