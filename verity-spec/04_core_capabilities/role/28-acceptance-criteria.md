...
## role/28-acceptance-criteria.md
...
This document details the `role` capability specs for the `28 Acceptance Criteria` contract.

### REQ-ROLE-28ACCEPTANCECRITERIA-001
*   **Requirement**: The capability manages `Role, RoleComposition` elements.
*   **Status**: `[FACT]`
*   **Source Reference**: `odoo/addons/base/models/res_groups.py`

### REQ-ROLE-28ACCEPTANCECRITERIA-002
*   **Requirement**: State changes are constrained to enums: `ACTIVE, INACTIVE`.
*   **Status**: `[FACT]`

### REQ-ROLE-28ACCEPTANCECRITERIA-003
*   **Requirement**: Mutations are restricted to actions: `create_role, compose_role, delete_role`.
*   **Status**: `[FACT]`

### REQ-ROLE-28ACCEPTANCECRITERIA-004
