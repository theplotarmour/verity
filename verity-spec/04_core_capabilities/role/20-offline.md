...
This document maps all write actions and entity fields within the `role` capability to their designated Conflict Policy class.
...
### REQ-ROLE-OFFLINE-001
*   **Requirement**: Every mutating transaction in `role` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
