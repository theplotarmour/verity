...
## organization/22-integrations.md
...
This document details the `organization` capability specs for the `22 Integrations` contract.

### REQ-ORGANIZATION-22INTEGRATIONS-001
