...
## organization/17-evidence-and-audit.md
...
This document details the `organization` capability specs for the `17 Evidence And Audit` contract.

### REQ-ORGANIZATION-17EVIDENCEANDAUDIT-001
...
### REQ-ORGANIZATION-17EVIDENCEANDAUDIT-002
*   **Requirement**: State changes are constrained to enums: `ACTIVE, INACTIVE`.
*   **Status**: `[FACT]`

### REQ-ORGANIZATION-17EVIDENCEANDAUDIT-003
*   **Requirement**: Mutations are restricted to actions: `create_org, update_org, add_member, remove_member`.
*   **Status**: `[FACT]`

### REQ-ORGANIZATION-17EVIDENCEANDAUDIT-004
