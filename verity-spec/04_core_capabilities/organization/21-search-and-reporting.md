...
## organization/21-search-and-reporting.md
...
This document details the `organization` capability specs for the `21 Search And Reporting` contract.

### REQ-ORGANIZATION-21SEARCHANDREPORTING-001
...
### REQ-ORGANIZATION-21SEARCHANDREPORTING-002
*   **Requirement**: State changes are constrained to enums: `ACTIVE, INACTIVE`.
*   **Status**: `[UNKNOWN]`

### REQ-ORGANIZATION-21SEARCHANDREPORTING-003
*   **Requirement**: Mutations are restricted to actions: `create_org, update_org, add_member, remove_member`.
*   **Status**: `[UNKNOWN]`

### REQ-ORGANIZATION-21SEARCHANDREPORTING-004
