...
## organization/23-configuration.md
...
This document details the `organization` capability specs for the `23 Configuration` contract.

### REQ-ORGANIZATION-23CONFIGURATION-001
