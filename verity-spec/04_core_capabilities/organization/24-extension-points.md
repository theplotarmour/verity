...
## organization/24-extension-points.md
...
This document details the `organization` capability specs for the `24 Extension Points` contract.

### REQ-ORGANIZATION-24EXTENSIONPOINTS-001
