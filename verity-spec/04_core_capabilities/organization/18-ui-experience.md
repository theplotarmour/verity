...
## organization/18-ui-experience.md
...
This document details the `organization` capability specs for the `18 Ui Experience` contract.

### REQ-ORGANIZATION-18UIEXPERIENCE-001
