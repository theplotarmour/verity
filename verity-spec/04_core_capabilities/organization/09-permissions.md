...
## organization/09-permissions.md
...
This document details the `organization` capability specs for the `09 Permissions` contract.

### REQ-ORGANIZATION-09PERMISSIONS-001
