...
This document maps all write actions and entity fields within the `notification` capability to their designated Conflict Policy class.
...
### REQ-NOTIFICATION-OFFLINE-001
*   **Requirement**: Every mutating transaction in `notification` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
