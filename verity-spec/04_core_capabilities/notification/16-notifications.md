...
## notification/16-notifications.md
...
This document details the `notification` capability specs for the `16 Notifications` contract.

### REQ-NOTIFICATION-16NOTIFICATIONS-001
