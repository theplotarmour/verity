...
## notification/11-business-rules.md
...
This document details the `notification` capability specs for the `11 Business Rules` contract.

### REQ-NOTIFICATION-11BUSINESSRULES-001
