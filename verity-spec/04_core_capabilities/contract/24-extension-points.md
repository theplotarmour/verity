...
## contract/24-extension-points.md
...
This document details the `contract` capability specs for the `24 Extension Points` contract.

### REQ-CONTRACT-24EXTENSIONPOINTS-001
