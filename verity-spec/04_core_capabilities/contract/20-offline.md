...
This document maps all write actions and entity fields within the `contract` capability to their designated Conflict Policy class.
...
### REQ-CONTRACT-OFFLINE-001
*   **Requirement**: Every mutating transaction in `contract` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
