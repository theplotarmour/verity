...
## contract/21-search-and-reporting.md
...
This document details the `contract` capability specs for the `21 Search And Reporting` contract.

### REQ-CONTRACT-21SEARCHANDREPORTING-001
