...
## contract/25-failure-and-exceptions.md
...
This document details the `contract` capability specs for the `25 Failure And Exceptions` contract.

### REQ-CONTRACT-25FAILUREANDEXCEPTIONS-001
