...
## procurement/24-extension-points.md
...
This document details the `procurement` capability specs for the `24 Extension Points` contract.

### REQ-PROCUREMENT-24EXTENSIONPOINTS-001
