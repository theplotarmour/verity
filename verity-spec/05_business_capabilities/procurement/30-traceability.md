...
## procurement/30-traceability.md
...
This document details the `procurement` capability specs for the `30 Traceability` contract.

### REQ-PROCUREMENT-30TRACEABILITY-001
