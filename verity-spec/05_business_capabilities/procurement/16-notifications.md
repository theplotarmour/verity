...
## procurement/16-notifications.md
...
This document details the `procurement` capability specs for the `16 Notifications` contract.

### REQ-PROCUREMENT-16NOTIFICATIONS-001
