...
## procurement/23-configuration.md
...
This document details the `procurement` capability specs for the `23 Configuration` contract.

### REQ-PROCUREMENT-23CONFIGURATION-001
