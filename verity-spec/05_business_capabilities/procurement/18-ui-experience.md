...
## procurement/18-ui-experience.md
...
This document details the `procurement` capability specs for the `18 Ui Experience` contract.

### REQ-PROCUREMENT-18UIEXPERIENCE-001
