...
This document maps all write actions and entity fields within the `crm` capability to their designated Conflict Policy class.
...
### REQ-CRM-OFFLINE-001
*   **Requirement**: Every mutating transaction in `crm` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
