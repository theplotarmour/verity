...
This document maps all write actions and entity fields within the `commerce` capability to their designated Conflict Policy class.
...
### REQ-COMMERCE-OFFLINE-001
*   **Requirement**: Every mutating transaction in `commerce` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
