...
## commerce/24-extension-points.md
...
This document details the `commerce` capability specs for the `24 Extension Points` contract.

### REQ-COMMERCE-24EXTENSIONPOINTS-001
