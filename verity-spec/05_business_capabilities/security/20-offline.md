...
This document maps all write actions and entity fields within the `security` capability to their designated Conflict Policy class.
...
### REQ-SECURITY-OFFLINE-001
*   **Requirement**: Every mutating transaction in `security` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
