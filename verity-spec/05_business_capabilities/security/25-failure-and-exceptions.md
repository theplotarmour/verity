...
## security/25-failure-and-exceptions.md
...
This document details the `security` capability specs for the `25 Failure And Exceptions` contract.

### REQ-SECURITY-25FAILUREANDEXCEPTIONS-001
