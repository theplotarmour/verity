...
## sales/25-failure-and-exceptions.md
...
This document details the `sales` capability specs for the `25 Failure And Exceptions` contract.

### REQ-SALES-25FAILUREANDEXCEPTIONS-001
