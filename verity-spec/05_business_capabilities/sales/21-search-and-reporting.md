...
## sales/21-search-and-reporting.md
...
This document details the `sales` capability specs for the `21 Search And Reporting` contract.

### REQ-SALES-21SEARCHANDREPORTING-001
