...
## field-service/25-failure-and-exceptions.md
...
This document details the `field-service` capability specs for the `25 Failure And Exceptions` contract.

### REQ-FIELD-SERVICE-25FAILUREANDEXCEPTIONS-001
