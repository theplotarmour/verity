...
## field-service/09-permissions.md
...
This document details the `field-service` capability specs for the `09 Permissions` contract.

### REQ-FIELD-SERVICE-09PERMISSIONS-001
