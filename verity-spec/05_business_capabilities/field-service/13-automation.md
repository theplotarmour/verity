...
## field-service/13-automation.md
...
This document details the `field-service` capability specs for the `13 Automation` contract.

### REQ-FIELD-SERVICE-13AUTOMATION-001
