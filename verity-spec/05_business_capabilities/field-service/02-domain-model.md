...
## field-service/02-domain-model.md
...
This document details the `field-service` capability specs for the `02 Domain Model` contract.

### REQ-FIELD-SERVICE-02DOMAINMODEL-001
