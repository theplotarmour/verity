...
## field-service/22-integrations.md
...
This document details the `field-service` capability specs for the `22 Integrations` contract.

### REQ-FIELD-SERVICE-22INTEGRATIONS-001
