...
## field-service/24-extension-points.md
...
This document details the `field-service` capability specs for the `24 Extension Points` contract.

### REQ-FIELD-SERVICE-24EXTENSIONPOINTS-001
