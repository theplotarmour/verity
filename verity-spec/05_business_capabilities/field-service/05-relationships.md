...
## field-service/05-relationships.md
...
This document details the `field-service` capability specs for the `05 Relationships` contract.

### REQ-FIELD-SERVICE-05RELATIONSHIPS-001
