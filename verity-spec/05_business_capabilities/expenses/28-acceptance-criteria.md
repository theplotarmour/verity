...
## expenses/28-acceptance-criteria.md
...
This document details the `expenses` capability specs for the `28 Acceptance Criteria` contract.

### REQ-EXPENSES-28ACCEPTANCECRITERIA-001
