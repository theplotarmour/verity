...
## expenses/25-failure-and-exceptions.md
...
This document details the `expenses` capability specs for the `25 Failure And Exceptions` contract.

### REQ-EXPENSES-25FAILUREANDEXCEPTIONS-001
