...
## expenses/24-extension-points.md
...
This document details the `expenses` capability specs for the `24 Extension Points` contract.

### REQ-EXPENSES-24EXTENSIONPOINTS-001
