...
## expenses/01-purpose-and-scope.md
...
This document details the `expenses` capability specs for the `01 Purpose And Scope` contract.

### REQ-EXPENSES-01PURPOSEANDSCOPE-001
