...
This document maps all write actions and entity fields within the `inventory` capability to their designated Conflict Policy class.
...
### REQ-INVENTORY-OFFLINE-001
*   **Requirement**: Every mutating transaction in `inventory` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
