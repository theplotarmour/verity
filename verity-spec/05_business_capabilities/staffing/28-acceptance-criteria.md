...
## staffing/28-acceptance-criteria.md
...
This document details the `staffing` capability specs for the `28 Acceptance Criteria` contract.

### REQ-STAFFING-28ACCEPTANCECRITERIA-001
