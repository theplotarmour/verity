...
This document maps all write actions and entity fields within the `staffing` capability to their designated Conflict Policy class.
...
### REQ-STAFFING-OFFLINE-001
*   **Requirement**: Every mutating transaction in `staffing` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
