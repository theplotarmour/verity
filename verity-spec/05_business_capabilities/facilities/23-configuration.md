...
## facilities/23-configuration.md
...
This document details the `facilities` capability specs for the `23 Configuration` contract.

### REQ-FACILITIES-23CONFIGURATION-001
