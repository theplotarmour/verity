...
## facilities/05-relationships.md
...
This document details the `facilities` capability specs for the `05 Relationships` contract.

### REQ-FACILITIES-05RELATIONSHIPS-001
