...
This document maps all write actions and entity fields within the `facilities` capability to their designated Conflict Policy class.
...
### REQ-FACILITIES-OFFLINE-001
*   **Requirement**: Every mutating transaction in `facilities` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
