...
## projects/28-acceptance-criteria.md
...
This document details the `projects` capability specs for the `28 Acceptance Criteria` contract.

### REQ-PROJECTS-28ACCEPTANCECRITERIA-001
