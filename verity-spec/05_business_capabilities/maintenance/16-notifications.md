...
## maintenance/16-notifications.md
...
This document details the `maintenance` capability specs for the `16 Notifications` contract.

### REQ-MAINTENANCE-16NOTIFICATIONS-001
