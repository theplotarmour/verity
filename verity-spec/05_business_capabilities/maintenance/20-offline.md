...
This document maps all write actions and entity fields within the `maintenance` capability to their designated Conflict Policy class.
...
### REQ-MAINTENANCE-OFFLINE-001
*   **Requirement**: Every mutating transaction in `maintenance` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
