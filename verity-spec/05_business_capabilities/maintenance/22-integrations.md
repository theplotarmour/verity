...
## maintenance/22-integrations.md
...
This document details the `maintenance` capability specs for the `22 Integrations` contract.

### REQ-MAINTENANCE-22INTEGRATIONS-001
