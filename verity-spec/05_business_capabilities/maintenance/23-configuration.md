...
## maintenance/23-configuration.md
...
This document details the `maintenance` capability specs for the `23 Configuration` contract.

### REQ-MAINTENANCE-23CONFIGURATION-001
