...
## subscriptions/25-failure-and-exceptions.md
...
This document details the `subscriptions` capability specs for the `25 Failure And Exceptions` contract.

### REQ-SUBSCRIPTIONS-25FAILUREANDEXCEPTIONS-001
