...
## subscriptions/16-notifications.md
...
This document details the `subscriptions` capability specs for the `16 Notifications` contract.

### REQ-SUBSCRIPTIONS-16NOTIFICATIONS-001
