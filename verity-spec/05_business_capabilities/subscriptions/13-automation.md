...
## subscriptions/13-automation.md
...
This document details the `subscriptions` capability specs for the `13 Automation` contract.

### REQ-SUBSCRIPTIONS-13AUTOMATION-001
