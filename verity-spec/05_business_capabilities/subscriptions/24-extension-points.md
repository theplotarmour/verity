...
## subscriptions/24-extension-points.md
...
This document details the `subscriptions` capability specs for the `24 Extension Points` contract.

### REQ-SUBSCRIPTIONS-24EXTENSIONPOINTS-001
