...
## subscriptions/30-traceability.md
...
This document details the `subscriptions` capability specs for the `30 Traceability` contract.

### REQ-SUBSCRIPTIONS-30TRACEABILITY-001
