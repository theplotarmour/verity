...
## subscriptions/01-purpose-and-scope.md
...
This document details the `subscriptions` capability specs for the `01 Purpose And Scope` contract.

### REQ-SUBSCRIPTIONS-01PURPOSEANDSCOPE-001
