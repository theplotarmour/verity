...
This document maps all write actions and entity fields within the `subscriptions` capability to their designated Conflict Policy class.
...
### REQ-SUBSCRIPTIONS-OFFLINE-001
*   **Requirement**: Every mutating transaction in `subscriptions` must evaluate conflict policy classes before resolving offline queues.
*   **Status**: `[DECIDED]`
