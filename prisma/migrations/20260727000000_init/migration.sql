...
-- CreateIndex
CREATE UNIQUE INDEX "Blueprint_productVariantId_key" ON "Blueprint"("productVariantId");
...
-- AddForeignKey
ALTER TABLE "Blueprint" ADD CONSTRAINT "Blueprint_productVariantId_fkey" FOREIGN KEY ("productVariantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
