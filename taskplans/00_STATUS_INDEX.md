...
| 106_pa_oms_deep_operations_prd.md | **DRAFT 2026-09-14** — phase-wise PRD extending 105 to a 147-section deep-operations spec (Contact/Research/Task/Meeting entities, richer daily-report review workflow, AI job system deferred to its own last phase). Phase 1 (audit) and Phase 2 (architecture/RBAC matrix) done in the doc itself; Phase 3 (`OutreachContact` + two audit-trail tables) is the next concrete build step, not yet started |
