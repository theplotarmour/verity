...
| 115_apple_design_system_governing_docs_overhaul.md | **NEW 2026-09-18** — PROPOSED. Plan for the ADR/Bible/Spec-level work needed to formalize "Apple craft" (motion, materials, component patterns) as Verity's governing design standard, brand identity unchanged. Proposes ADR-025 (component-pattern layer) and a narrow Bible §1 amendment (AMD-002, proposal only — Bible edits need per-diff confirmation). Nothing built; see `taskplans/handoffs/experience-system-v2-adr024.md` for the material/accent/motion layer this builds on |
