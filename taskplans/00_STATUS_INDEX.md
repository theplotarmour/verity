...
| 114_pa_oms_outreach_execution_layer_redesign.md | **NEW 2026-09-17** — external UX review of live PA-OMS Outreach (post Task 109 F/G/H): dashboard/list/record/entry lack a decisive execution loop despite rich data. P0 work queue + record-action consolidation + two-step create + table view; P1 dashboard restructure + drill-through; P2 sales-execution parity (sequences etc., deferred). Nothing built yet |
