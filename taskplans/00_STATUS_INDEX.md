...
| 105_pa_oms_outreach_capability.md | **Phases 0/0.5/1/2/3/4/5 BUILT and LIVE 2026-09-12/13** — full command coverage in UI, role-scoped Junior/Senior/Company-Core views (pragmatic scope, not a full redesign), Company Direction + Attention exceptions, company weekly roll-up + bottleneck detection, per-team permission enforcement, 14 passing tests, all 19 real logins. Open: a real visual redesign of the 3 role views (still reuses one design system's ordinary components), vertical/channel intelligence, Phase 6 (deferred P2) |
