...
def build_docs() -> None:
    write(
        DOCS / "README.md",
        """
        # VEDA Documentation Authority

        `docs/` is the only canonical source of truth for VEDA product, architecture, workflow, data, design, API, security, deployment, and roadmap decisions.
        ...
        - VEDA is described as a production-grade configurable Factory Operating System. Do not describe it as an MVP.

        ## Reading Order

        1. `00_Vision/01_VEDA_Vision.md`
        2. `01_Product/01_Product_Bible.md`
        3. `14_DECISIONS/0001-why-veda-docs-are-canonical.md`
    ...
    write(
        DOCS / "00_Vision/01_VEDA_Vision.md",
        """
        # VEDA Vision
        ...
        VEDA exists to let a factory define its business once and reuse that definition across sales, production, inventory, quality, dispatch, reporting, worker guidance, and future automation.
        ...
        - Every role should experience VEDA as a focused operating surface, not a back-office form dump.
        ...
        - VEDA is not a generic horizontal task manager.
        - VEDA is not a report-only BI shell.
        - VEDA is not a clone of ERPNext, SAP, Odoo, or Katana.
        - VEDA should not require developer intervention for ordinary factory configuration such as product, route, QC, or dashboard updates.

        ## Product Statement

        VEDA is a configurable Factory Operating System where business engines and reusable blueprints let a manufacturing organization launch products, run departments, control quality, guide workers, and scale execution without fragmenting operational truth across disconnected modules.
        """,
    )
    ...
    write(
        ...
        VEDA is a production-grade Factory Operating System for manufacturing organizations that need configurable operational depth without enterprise-software complexity leaking into daily execution.
        ...
        - Against ERP suites: VEDA wins on operator clarity, blueprint-centered reuse, and configurable execution
        - Against narrow QC tools: VEDA wins by connecting quality to sales, planning, stock, routing, and dispatch
        - Against generic SaaS dashboards: VEDA wins by owning the operating system, not just reporting
    ...
    write(
        ...
        This folder captures research inputs that inform VEDA. These references are useful inputs, but they are not canonical requirements until converted into decision, architecture, workflow, or engine documents.
        ...
        - Borrow visual patterns only after adapting them to VEDA role semantics
    ...
    write(
        ...
        VEDA should be organized as a configurable operating platform where business engines own state transitions and operational decisions, while route surfaces, server actions, storage utilities, and worker UIs expose those capabilities to specific roles.
    ...
    write(
        ...
        VEDA should coordinate engines through business events, not through a generic task table pretending to represent every operational action.
    ...
    write(
        ...
        The Blueprint System is the reusable operational DNA of VEDA.
    ...
    for filename, purpose in design_docs.items():
        ...
        write(
            ...
            - VEDA must feel intentional, premium, and operational
    ...
    for filename, purpose in security_docs.items():
        ...
        write(
            ...
            VEDA is treated as a production-grade system. Security design must be explicit, reviewable, and connected to workflows, data, and deployment operations.
            """,
        )
    ...
    decisions = {
        "0001-why-veda-docs-are-canonical.md": "Docs are the authority that implementation follows.",
        ...
        "0004-why-veda-uses-a-factory-builder.md": "Owners need configurability without developer dependency.",
        "0005-why-veda-does-not-use-generic-tasks-as-the-core.md": "Events and engine-owned artifacts are more faithful than a generic task abstraction.",
        "0006-why-veda-should-be-event-driven.md": "Events coordinate the operating system more cleanly than tight point-to-point coupling.",
...
def main() -> None:
    reset_docs()
    build_docs()
    print("VEDA docs regenerated successfully.")
