---
doc_id: API-PURCHASE_COMMITMENT
title: API contract — Purchase Commitment
generated: true
source_model: _model/capabilities/procurement.yaml
regenerate_with: python3 _tools/generate.py
---

# API contract — Purchase Commitment
...
|---|---|---|---|---|
| GET | `/api/v1/procurement/purchase_commitment` | list | `list` | yes |
| GET | `/api/v1/procurement/purchase_commitment/{id}` | read | `view` | yes |
...
> Location: `purchase_commitment.api.query_semantics` · Capability: `procurement`  
> **Blocks:** `ui:list:purchase_commitment`, `performance:purchase_commitment`  
