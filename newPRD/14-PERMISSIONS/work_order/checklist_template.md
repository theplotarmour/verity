---
doc_id: PERM-CHECKLIST_TEMPLATE
title: Permission matrix — Checklist Template
generated: true
...
# Permission matrix — Checklist Template
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `checklist_template.permission_defaults`.
