---
doc_id: PERM-WORK_TYPE
title: Permission matrix — Work Type
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `work_type.permission_defaults`.
