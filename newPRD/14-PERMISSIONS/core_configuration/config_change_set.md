---
doc_id: PERM-CONFIG_CHANGE_SET
title: Permission matrix — Configuration Change Set
generated: true
...
# Permission matrix — Configuration Change Set
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `config_change_set.permission_defaults`.
