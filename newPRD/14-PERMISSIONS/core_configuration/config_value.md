---
doc_id: PERM-CONFIG_VALUE
title: Permission matrix — Configuration Value
generated: true
...
# Permission matrix — Configuration Value
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `config_value.permission_defaults`.
