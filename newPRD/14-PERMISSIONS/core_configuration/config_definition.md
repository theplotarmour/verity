---
doc_id: PERM-CONFIG_DEFINITION
title: Permission matrix — Configuration Definition
generated: true
...
# Permission matrix — Configuration Definition
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `config_definition.permission_defaults`.
