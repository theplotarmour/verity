---
doc_id: PERM-EVIDENCE_ITEM
title: Permission matrix — Evidence Item
generated: true
...
# Permission matrix — Evidence Item
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `evidence_item.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `position` | `view_sensitive` | marked in model |
