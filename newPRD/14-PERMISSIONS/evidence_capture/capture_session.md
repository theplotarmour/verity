---
doc_id: PERM-CAPTURE_SESSION
title: Permission matrix — Capture Session
generated: true
...
# Permission matrix — Capture Session
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `capture_session.permission_defaults`.
