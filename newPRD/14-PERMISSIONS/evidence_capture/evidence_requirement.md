---
doc_id: PERM-EVIDENCE_REQUIREMENT
title: Permission matrix — Evidence Requirement
generated: true
...
# Permission matrix — Evidence Requirement
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `evidence_requirement.permission_defaults`.
