---
doc_id: PERM-STOCK_RESERVATION
title: Permission matrix — Stock Reservation
generated: true
...
# Permission matrix — Stock Reservation
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `stock_reservation.permission_defaults`.
