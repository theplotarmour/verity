---
doc_id: PERM-STOCK_MOVEMENT
title: Permission matrix — Stock Movement
generated: true
...
# Permission matrix — Stock Movement
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `stock_movement.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `unit_cost_minor` | `view_financial` | the cost applied to this movement by the valuation method at the time. Frozen, because recomputing history is how two valuations of the same past appear |
