---
doc_id: PERM-STOCK_LOCATION
title: Permission matrix — Stock Location
generated: true
...
# Permission matrix — Stock Location
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `stock_location.permission_defaults`.
