---
doc_id: PERM-STOCK_COUNT
title: Permission matrix — Stock Count
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `stock_count.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `variance_value_minor` | `view_financial` | marked in model |
