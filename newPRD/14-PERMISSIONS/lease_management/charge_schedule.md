---
doc_id: PERM-CHARGE_SCHEDULE
title: Permission matrix — Charge Schedule
generated: true
...
# Permission matrix — Charge Schedule
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `charge_schedule.permission_defaults`.
