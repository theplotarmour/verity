---
doc_id: PERM-ESCALATION_RULE
title: Permission matrix — Escalation Rule
generated: true
...
# Permission matrix — Escalation Rule
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `escalation_rule.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `percentage` | `view_financial` | marked in model |
| `amount_minor` | `view_financial` | marked in model |
| `floor_percentage` | `view_financial` | marked in model |
| `cap_percentage` | `view_financial` | marked in model |
