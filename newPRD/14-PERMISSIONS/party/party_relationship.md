---
doc_id: PERM-PARTY_RELATIONSHIP
title: Permission matrix — Party Relationship
generated: true
...
# Permission matrix — Party Relationship
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `party_relationship.permission_defaults`.
