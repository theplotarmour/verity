---
doc_id: PERM-PARTY_CHANNEL
title: Permission matrix — Party Channel
generated: true
...
# Permission matrix — Party Channel
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `party_channel.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `value` | `view_sensitive` | marked in model |
