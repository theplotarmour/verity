---
doc_id: PERM-MERGE_PROPOSAL
title: Permission matrix — Merge Proposal
generated: true
...
# Permission matrix — Merge Proposal
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `merge_proposal.permission_defaults`.
