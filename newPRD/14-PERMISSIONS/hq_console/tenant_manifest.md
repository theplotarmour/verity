---
doc_id: PERM-TENANT_MANIFEST
title: Permission matrix — Tenant Manifest
generated: true
...
# Permission matrix — Tenant Manifest
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `tenant_manifest.permission_defaults`.
