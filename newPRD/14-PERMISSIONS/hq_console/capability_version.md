---
doc_id: PERM-CAPABILITY_VERSION
title: Permission matrix — Capability Version
generated: true
...
# Permission matrix — Capability Version
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `capability_version.permission_defaults`.
