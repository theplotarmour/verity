---
doc_id: PERM-DEPLOYMENT
title: Permission matrix — Deployment
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `deployment.permission_defaults`.
