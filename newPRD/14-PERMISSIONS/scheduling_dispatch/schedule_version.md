---
doc_id: PERM-SCHEDULE_VERSION
title: Permission matrix — Schedule Version
generated: true
...
# Permission matrix — Schedule Version
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `schedule_version.permission_defaults`.
