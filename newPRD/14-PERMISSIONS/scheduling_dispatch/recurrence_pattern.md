---
doc_id: PERM-RECURRENCE_PATTERN
title: Permission matrix — Recurrence Pattern
generated: true
...
# Permission matrix — Recurrence Pattern
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `recurrence_pattern.permission_defaults`.
