---
doc_id: PERM-DEMAND
title: Permission matrix — Demand
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `demand.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `cost_ceiling_minor` | `view_financial` | marked in model |
