---
doc_id: PERM-CATALOG_ITEM
title: Permission matrix — Catalog Item
generated: true
...
# Permission matrix — Catalog Item
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `catalog_item.permission_defaults`.
