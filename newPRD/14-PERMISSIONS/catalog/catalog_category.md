---
doc_id: PERM-CATALOG_CATEGORY
title: Permission matrix — Category
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `catalog_category.permission_defaults`.
