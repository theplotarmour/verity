---
doc_id: PERM-VARIANT_OPTION
title: Permission matrix — Variant and Modifier Option
generated: true
...
# Permission matrix — Variant and Modifier Option
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `variant_option.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `price_delta_minor` | `view_financial` | marked in model |
| `price_delta_is_percent` | `view_financial` | marked in model |
