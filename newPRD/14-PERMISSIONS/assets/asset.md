...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `asset.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `acquisition_cost_minor` | `view_financial` | marked in model |
| `expected_life_months` | `view_financial` | marked in model |
| `residual_value_minor` | `view_financial` | marked in model |
| `disposal_proceeds_minor` | `view_financial` | marked in model |
