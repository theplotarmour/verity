---
doc_id: PERM-ASSET_CLASS
title: Permission matrix — Asset Class
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `asset_class.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `depreciation_method` | `view_financial` | marked in model |
| `default_life_months` | `view_financial` | marked in model |
