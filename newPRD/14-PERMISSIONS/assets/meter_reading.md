---
doc_id: PERM-METER_READING
title: Permission matrix — Meter Reading
generated: true
...
# Permission matrix — Meter Reading
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `meter_reading.permission_defaults`.
