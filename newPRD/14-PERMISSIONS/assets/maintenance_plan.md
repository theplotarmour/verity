---
doc_id: PERM-MAINTENANCE_PLAN
title: Permission matrix — Maintenance Plan
generated: true
...
# Permission matrix — Maintenance Plan
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `maintenance_plan.permission_defaults`.
