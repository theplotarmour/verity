---
doc_id: PERM-TICKET_MESSAGE
title: Permission matrix — Ticket Message
generated: true
...
# Permission matrix — Ticket Message
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `ticket_message.permission_defaults`.
