...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `ticket_category.permission_defaults`.
