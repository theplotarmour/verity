---
doc_id: PERM-QUEUED_MUTATION
title: Permission matrix — Queued Mutation
generated: true
...
# Permission matrix — Queued Mutation
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `queued_mutation.permission_defaults`.
