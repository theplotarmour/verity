---
doc_id: PERM-SYNC_CONFLICT
title: Permission matrix — Sync Conflict
generated: true
...
# Permission matrix — Sync Conflict
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `sync_conflict.permission_defaults`.
