---
doc_id: PERM-DEVICE_STORE
title: Permission matrix — Device Store
generated: true
...
# Permission matrix — Device Store
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `device_store.permission_defaults`.
