---
doc_id: PERM-LOCATION
title: Permission matrix — Location
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `location.permission_defaults`.
