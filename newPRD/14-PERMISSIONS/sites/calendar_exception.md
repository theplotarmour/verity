---
doc_id: PERM-CALENDAR_EXCEPTION
title: Permission matrix — Calendar Exception
generated: true
...
# Permission matrix — Calendar Exception
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `calendar_exception.permission_defaults`.
