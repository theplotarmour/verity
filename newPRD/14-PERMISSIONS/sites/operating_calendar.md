---
doc_id: PERM-OPERATING_CALENDAR
title: Permission matrix — Operating Calendar
generated: true
...
# Permission matrix — Operating Calendar
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `operating_calendar.permission_defaults`.
