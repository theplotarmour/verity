---
doc_id: PERM-GEOFENCE
title: Permission matrix — Geofence
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `geofence.permission_defaults`.
