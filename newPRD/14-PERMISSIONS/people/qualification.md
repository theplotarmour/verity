---
doc_id: PERM-QUALIFICATION
title: Permission matrix — Qualification
generated: true
...
# Permission matrix — Qualification
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `qualification.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `reference` | `view_sensitive` | the issuing body's reference. Sensitive because it is frequently a personal identifier |
