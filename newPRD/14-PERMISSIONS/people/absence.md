---
doc_id: PERM-ABSENCE
title: Permission matrix — Absence
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `absence.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `reason_text` | `view_sensitive` | sensitive because a reason for a medical absence is health information. The KIND is visible to a dispatcher; the reason is not |
| `evidence_ref` | `view_sensitive` | marked in model |
