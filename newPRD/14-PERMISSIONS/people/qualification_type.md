---
doc_id: PERM-QUALIFICATION_TYPE
title: Permission matrix — Qualification Type
generated: true
...
# Permission matrix — Qualification Type
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `qualification_type.permission_defaults`.
