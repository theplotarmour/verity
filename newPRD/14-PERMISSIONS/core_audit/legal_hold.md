---
doc_id: PERM-LEGAL_HOLD
title: Permission matrix — Legal Hold
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `legal_hold.permission_defaults`.
