---
doc_id: PERM-AUDIT_DIGEST
title: Permission matrix — Audit Digest
generated: true
...
# Permission matrix — Audit Digest
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `audit_digest.permission_defaults`.
