---
doc_id: PERM-BILLABLE_OUTCOME
title: Permission matrix — Billable Outcome
generated: true
...
# Permission matrix — Billable Outcome
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `billable_outcome.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `rated_amount_minor` | `view_financial` | marked in model |
| `rate_rule_ref` | `view_financial` | which rule produced the amount, captured at rating time |
