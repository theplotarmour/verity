---
doc_id: PERM-ESCALATION_POLICY
title: Permission matrix — Escalation Policy
generated: true
...
# Permission matrix — Escalation Policy
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `escalation_policy.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `allow_premium` | `view_financial` | marked in model |
| `max_premium_percent` | `view_financial` | marked in model |
