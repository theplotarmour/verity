---
doc_id: PERM-BACKFILL_REQUEST
title: Permission matrix — Backfill Request
generated: true
...
# Permission matrix — Backfill Request
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `backfill_request.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `billing_classification` | `view_financial` | a classification recorded here and priced elsewhere. The rule that sets it is tenant policy |
| `premium_applied` | `view_financial` | whether a short-notice premium was offered to secure the cover |
