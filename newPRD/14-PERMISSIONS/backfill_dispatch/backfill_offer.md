---
doc_id: PERM-BACKFILL_OFFER
title: Permission matrix — Backfill Offer
generated: true
...
# Permission matrix — Backfill Offer
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `backfill_offer.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `premium_percent` | `view_financial` | marked in model |
