---
doc_id: PERM-SESSION
title: Permission matrix — Session
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `session.permission_defaults`.
