---
doc_id: PERM-DEVICE
title: Permission matrix — Device
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `device.permission_defaults`.
