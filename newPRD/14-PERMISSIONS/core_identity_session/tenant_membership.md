---
doc_id: PERM-TENANT_MEMBERSHIP
title: Permission matrix — Tenant Membership
generated: true
...
# Permission matrix — Tenant Membership
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `tenant_membership.permission_defaults`.
