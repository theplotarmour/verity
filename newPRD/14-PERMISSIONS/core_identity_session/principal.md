---
doc_id: PERM-PRINCIPAL
title: Permission matrix — Principal
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `principal.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `primary_email` | `view_sensitive` | 'nullable because Indian field workforce onboards by phone, not email |
