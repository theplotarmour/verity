---
doc_id: PERM-WAITLIST_ENTRY
title: Permission matrix — Waitlist Entry
generated: true
...
# Permission matrix — Waitlist Entry
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `waitlist_entry.permission_defaults`.
