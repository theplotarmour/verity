---
doc_id: PERM-CANCELLATION_POLICY
title: Permission matrix — Cancellation Policy
generated: true
...
# Permission matrix — Cancellation Policy
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `cancellation_policy.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `late_cancellation_charge_percent` | `view_financial` | marked in model |
| `no_show_charge_percent` | `view_financial` | marked in model |
| `deposit_percent` | `view_financial` | marked in model |
| `deposit_refundable_before_hours` | `view_financial` | marked in model |
| `reschedule_charge_percent` | `view_financial` | marked in model |
