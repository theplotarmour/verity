---
doc_id: PERM-PURCHASE_REQUEST
title: Permission matrix — Purchase Request
generated: true
...
# Permission matrix — Purchase Request
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `purchase_request.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `estimated_total_minor` | `view_financial` | marked in model |
