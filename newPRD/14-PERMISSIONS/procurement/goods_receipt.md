---
doc_id: PERM-GOODS_RECEIPT
title: Permission matrix — Receipt
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `goods_receipt.permission_defaults`.
