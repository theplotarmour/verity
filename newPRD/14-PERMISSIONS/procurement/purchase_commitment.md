---
doc_id: PERM-PURCHASE_COMMITMENT
title: Permission matrix — Purchase Commitment
generated: true
...
# Permission matrix — Purchase Commitment
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `purchase_commitment.permission_defaults`.
