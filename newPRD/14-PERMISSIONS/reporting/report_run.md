---
doc_id: PERM-REPORT_RUN
title: Permission matrix — Report Run
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `report_run.permission_defaults`.
