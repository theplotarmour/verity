---
doc_id: PERM-REPORT_EXPORT
title: Permission matrix — Export
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `report_export.permission_defaults`.
