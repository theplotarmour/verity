---
doc_id: PERM-METRIC_DEFINITION
title: Permission matrix — Metric Definition
generated: true
...
# Permission matrix — Metric Definition
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `metric_definition.permission_defaults`.
