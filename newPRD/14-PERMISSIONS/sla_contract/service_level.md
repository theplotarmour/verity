---
doc_id: PERM-SERVICE_LEVEL
title: Permission matrix — Service Level
generated: true
...
# Permission matrix — Service Level
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `service_level.permission_defaults`.
