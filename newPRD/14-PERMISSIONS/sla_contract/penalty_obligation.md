---
doc_id: PERM-PENALTY_OBLIGATION
title: Permission matrix — Penalty Obligation
generated: true
...
# Permission matrix — Penalty Obligation
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `penalty_obligation.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `calculated_amount_minor` | `view_financial` | marked in model |
| `capped_amount_minor` | `view_financial` | after the contract penalty cap, recorded separately so the difference between owed and payable is visible |
| `obligation_kind` | `view_financial` | marked in model |
