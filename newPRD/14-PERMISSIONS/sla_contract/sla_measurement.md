---
doc_id: PERM-SLA_MEASUREMENT
title: Permission matrix — SLA Measurement
generated: true
...
# Permission matrix — SLA Measurement
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `sla_measurement.permission_defaults`.
