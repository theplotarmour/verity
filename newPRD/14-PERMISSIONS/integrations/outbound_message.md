---
doc_id: PERM-OUTBOUND_MESSAGE
title: Permission matrix — Outbound Message
generated: true
...
# Permission matrix — Outbound Message
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `outbound_message.permission_defaults`.
