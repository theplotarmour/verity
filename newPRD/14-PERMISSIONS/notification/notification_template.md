---
doc_id: PERM-NOTIFICATION_TEMPLATE
title: Permission matrix — Template
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `notification_template.permission_defaults`.
