---
doc_id: PERM-NOTIFICATION_BATCH
title: Permission matrix — Batch
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `notification_batch.permission_defaults`.
