---
doc_id: PERM-NOTIFICATION_PREFERENCE
title: Permission matrix — Preference
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `notification_preference.permission_defaults`.
