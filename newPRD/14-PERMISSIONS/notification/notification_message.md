---
doc_id: PERM-NOTIFICATION_MESSAGE
title: Permission matrix — Message
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `notification_message.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `cost_class` | `view_financial` | marked in model |
| `estimated_cost_minor` | `view_financial` | marked in model |
