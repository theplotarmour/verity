---
doc_id: PERM-SEARCH_QUERY
title: Permission matrix — Search Query
generated: true
...
# Permission matrix — Search Query
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `search_query.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `term` | `view_sensitive` | sensitive because a search term is frequently a person's name, a phone number or a document number, and the log of what somebody searched for is itself a disclosure |
