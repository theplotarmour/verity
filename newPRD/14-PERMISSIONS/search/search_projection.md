---
doc_id: PERM-SEARCH_PROJECTION
title: Permission matrix — Search Projection
generated: true
...
# Permission matrix — Search Projection
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `search_projection.permission_defaults`.
