---
doc_id: PERM-SAVED_SEARCH
title: Permission matrix — Saved Search
generated: true
...
# Permission matrix — Saved Search
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `saved_search.permission_defaults`.
