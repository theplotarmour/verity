---
doc_id: PERM-PERMISSION_GRANT
title: Permission matrix — Permission Grant
generated: true
...
# Permission matrix — Permission Grant
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `permission_grant.permission_defaults`.
