---
doc_id: PERM-ROLE_BINDING
title: Permission matrix — Role Binding
generated: true
...
# Permission matrix — Role Binding
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `role_binding.permission_defaults`.
