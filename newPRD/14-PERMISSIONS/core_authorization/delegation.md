---
doc_id: PERM-DELEGATION
title: Permission matrix — Delegation
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `delegation.permission_defaults`.
