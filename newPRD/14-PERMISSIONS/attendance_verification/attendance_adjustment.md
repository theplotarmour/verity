---
doc_id: PERM-ATTENDANCE_ADJUSTMENT
title: Permission matrix — Attendance Adjustment
generated: true
...
# Permission matrix — Attendance Adjustment
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `attendance_adjustment.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `affects_billing` | `view_financial` | separate from affects_pay deliberately. A goodwill credit to a counterparty must not silently reduce somebody's wages |
