---
doc_id: PERM-ATTENDANCE_DISPUTE
title: Permission matrix — Attendance Dispute
generated: true
...
# Permission matrix — Attendance Dispute
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `attendance_dispute.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `financial_effect_minor` | `view_financial` | marked in model |
