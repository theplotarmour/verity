---
doc_id: PERM-ATTENDANCE_RECORD
title: Permission matrix — Attendance Record
generated: true
...
# Permission matrix — Attendance Record
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `attendance_record.permission_defaults`.

## Field-level gates

| Field | Gate verb | Rationale |
|---|---|---|
| `billable_minutes` | `view_financial` | derived separately from payable_minutes, because the two may legitimately differ and forcing one number is wrong for one of the parties |
