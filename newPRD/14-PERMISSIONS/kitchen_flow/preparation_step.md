---
doc_id: PERM-PREPARATION_STEP
title: Permission matrix — Preparation Step
generated: true
...
# Permission matrix — Preparation Step
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `preparation_step.permission_defaults`.
