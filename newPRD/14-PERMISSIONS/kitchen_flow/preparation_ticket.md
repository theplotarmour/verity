---
doc_id: PERM-PREPARATION_TICKET
title: Permission matrix — Preparation Ticket
generated: true
...
# Permission matrix — Preparation Ticket
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `preparation_ticket.permission_defaults`.
