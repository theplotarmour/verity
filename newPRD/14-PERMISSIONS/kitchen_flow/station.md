---
doc_id: PERM-STATION
title: Permission matrix — Station
generated: true
...
> Not specified in the model. This is a task, not an omission to be papered over. Owner: TBD. Blocks: implementation of `station.permission_defaults`.
